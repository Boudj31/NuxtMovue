  ...
  methods: {
    async getMovies() {
      const data = axios.get(
        `https://api.themoviedb.org/3/movie/now_playing?api_key=07fac00e8d97342d654141c90d6f9a4d&language=fr-FR&page=1`
      )
    ...
    async searchMovies() {
      const data = axios.get(
        `https://api.themoviedb.org/3/movie/now_playing?api_key=07fac00e8d97342d654141c90d6f9a4d&language=fr-FR&page=1&query=${this.searchInput}`
      )
      const result = await data
      result.data.results.forEach((movie) => {
